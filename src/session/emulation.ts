...
// The plain-data emulation vocabulary lives in `emulation-types.ts` so the
// EmulationSubstrate port can name it without reaching playwright-core through
// this module's appliers. Re-exported here so every existing importer is
// unchanged.
export type {
  ColorScheme,
  ReducedMotion,
  ...
  PermissionGrant,
  EmulationState,
} from "./emulation-types.js";
export { newEmulationState } from "./emulation-types.js";
import type {
  ColorScheme,
  ReducedMotion,
  GeolocationCoords,
