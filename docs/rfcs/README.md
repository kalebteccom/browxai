...
| [0007](0007-session-replay.md)              | Session replay: append-only capture log, offline player, retroactive devtools                     | Phases 1-3 shipped in v0.10.1 (2026-09-14). P4 (panel plugin API) and P5 (tier-b re-execution) not built.                                              |
| [0008](0008-native-app-control.md)          | Native app control (iOS simulator and Android emulator as engines, one `.browx` archive)          | Draft — design only, nothing built. Closes D8 in the decision matrix with the product input that had blocked it.                                       |
| [0009](0009-page-free-session-port.md)      | A Page-free session port (close the `page()` bypass; Target / Event / Element substrates)         | P1 shipped (#89): ports split, `TargetSubstrate`, declaration-keyed selection. P2-P5 not built.                                                        |
