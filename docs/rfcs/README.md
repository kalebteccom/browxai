...
| [0005](0005-harness-install-and-plugin-marketplace.md) | Harness install docs and plugin marketplace distribution                                          | Draft — proposal; covers hosted-relay onboarding, harness tabs, root marketplace catalogs, browser setup, schema discovery, and relay contracts.                         |
