...
| `05-safari-xpc.md` | Real-Safari feasibility: safaridriver-as-XPC-broker, the `webinspectord` XPC channel into live Safari, entitlement gates, and the AppleEvents / Web-Extension BYOB fallback tiers. *(In progress — the owner's XPC lead.)* |
