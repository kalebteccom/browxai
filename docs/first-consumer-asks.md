...
| W-C2 | recording | 🟢 | Calibration-walk → flow-file scaffold. | **deferred** — cross-cutting (browxai recording + site-docs YAML emission), needs coordination with site-docs side. Phase-2 candidate. |
