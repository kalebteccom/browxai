...
| `architecture/`        | Substrate-level architecture references: the Kalebtec architecture-principles doctrine, repo map deep dive, capability posture map, documentation contracts. |
