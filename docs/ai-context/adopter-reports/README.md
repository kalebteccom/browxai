...
- [`2026-05-20-codex.md`](2026-05-20-codex.md): Codex run against Clipro's authenticated SPA. Persistent profile, drag-reorder, eval_js/poll_eval state inspection, CSV upload via hidden file input.
...
- [`2026-09-14-sdk-calltool-surface.md`](2026-09-14-sdk-calltool-surface.md): SDK `callTool` is capped at the 45-entry `SDK_TOOLS` registry, so 144 server tools have no SDK path and the documented canvas/vision example throws. The refusal message also names an already-active capability as the remedy.
